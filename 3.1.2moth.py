...
def go_to_search_for(Money,year_column, index):
    ...
    if year_column and Money is not None:
        ...
        month_year, year_year = map(int, year_range1.split(' '))
        Money_data = df.loc[index, year_column]
 
        if year_data == start_year1 or year_data == end_year1 :
         Money_data1 += Money_data
        elif year_data == start_year2 or year_data == end_year2  :
         Money_data2 += Money_data
        elif  year_data == start_year3 or year_data == end_year3  :
         Money_data3 += Money_data
        elif year_data == start_year4 or year_data == end_year4  :
         Money_data4 += Money_data
        elif  year_data == start_year5 or year_data == end_year5  :
